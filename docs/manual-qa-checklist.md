...
```bash
./scripts/qa_focusyou_state.sh qa-create-recovery-import-fixture /tmp/focusyou-data-tools-qa
...
- `qa-smoke-recovery-import`는 현재 앱 데이터가 아니라 합성 fixture 백업을 만든 뒤 preview와 기본/히스토리 dry-run import를 검증합니다.
